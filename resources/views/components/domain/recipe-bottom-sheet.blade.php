...
<div x-show="openRecipe" class="fixed inset-0 z-50 flex items-end justify-center sm:items-center" style="display: none;">
    <!-- Backdrop -->
    <div x-show="openRecipe" x-transition.opacity class="fixed inset-0 bg-gray-900/40 backdrop-blur-sm" @click="openRecipe = false"></div>
    ...
    <div x-show="openRecipe" 
        ...
        <div class="flex-1 overflow-y-auto hide-scrollbar pt-14 pb-12">
            <div class="px-6 space-y-6">
                ...
                <div>
                    <h2 class="text-[22px] font-black text-gray-800 leading-tight mb-2">{{ $recipe['title'] ?? 'Sup Ayam Makaroni Sayur' }}</h2>
                ...
                <div>
                    <h3 class="text-[15px] font-black text-gray-800 mb-3">Bahan-bahan</h3>
                    <ul class="space-y-3 text-[13.5px] font-bold text-gray-600">
                ...
                <div>
                    <h3 class="text-[15px] font-black text-gray-800 mb-3">Langkah Memasak</h3>
                    <ol class="space-y-4 text-[13.5px] font-bold text-gray-600">
                        <li class="flex items-start">
                            <span class="w-6 h-6 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center flex-shrink-0 mr-3 mt-0.5 text-[11px] font-black">1</span>
                            <span class="pt-0.5 leading-relaxed">Tumis bawang putih hingga harum, masukkan air secukupnya. Tunggu hingga mendidih.</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-6 h-6 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center flex-shrink-0 mr-3 mt-0.5 text-[11px] font-black">2</span>
                            <span class="pt-0.5 leading-relaxed">Masukkan potongan ayam fillet, masak hingga ayam matang dan kaldu keluar.</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-6 h-6 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center flex-shrink-0 mr-3 mt-0.5 text-[11px] font-black">3</span>
