...
<div class="w-full min-h-screen bg-[#F8FAFC] pb-24 lg:pb-16 text-slate-800 antialiased font-sans">
    <div class="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-4 sm:py-7 flex flex-col gap-4 sm:gap-6">
            ...
            <div class="flex items-start sm:items-center gap-3 min-w-0">
                ...
                <div class="flex flex-col min-w-0">
                    <div class="flex flex-wrap items-center gap-1.5 sm:gap-2">
                        ...
                        <span class="text-xs sm:text-sm font-bold text-amber-950">{{ $statRevisi }} Balita Perlu Koreksi</span>
                    </div>
        ...
        {{-- ── 3. FOUR HARMONIOUS KPI CARDS (Mobile Responsive & Tight Spacing) ── --}}
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
            ...
            <div class="bg-white border border-slate-200/90 hover:border-slate-300 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between shadow-2xs hover:shadow-xs transition-all">
                ...
                <div class="mt-2.5 sm:mt-3.5">
                    ...
                    <span class="text-[10.5px] sm:text-[11.5px] text-slate-400 font-medium mt-1 block truncate">Populasi binaan</span>
                </div>
            </div>

            {{-- 2. Selesai Ditimbang --}}
            <div class="bg-white border border-emerald-200/90 hover:border-emerald-300 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between shadow-2xs hover:shadow-xs transition-all">
                <div class="flex items-center justify-between gap-1">
            ...
            {{-- 3. Belum Hadir --}}
            <div class="bg-white border border-amber-200/90 hover:border-amber-300 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between shadow-2xs hover:shadow-xs transition-all">
                <div class="flex items-center justify-between gap-1">
                ...
                <div class="mt-2.5 sm:mt-3.5">
                    ...
                    <a href="{{ route('balita.index', ['filter' => 'belum_diukur']) }}" class="text-[10.5px] sm:text-[11.5px] font-bold text-amber-800 hover:text-amber-950 mt-1 inline-flex items-center gap-0.5 truncate">
                        <span>Antrean hadir</span>
                        <x-icon name="caret-right" weight="bold" class="text-[10px] text-amber-700 shrink-0" />
                    </a>
                </div>
            </div>

            {{-- 4. Prioritas Pengawasan Gizi --}}
            <div class="bg-white border border-rose-200/90 hover:border-rose-300 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between shadow-2xs hover:shadow-xs transition-all">
                <div class="flex items-center justify-between gap-1">
                ...
                <div class="mt-2.5 sm:mt-3.5">
                    ...
                    <a href="{{ route('balita.index', ['filter' => 'absen_bulan_lalu']) }}" class="text-[10.5px] sm:text-[11.5px] font-bold text-rose-800 hover:text-rose-950 mt-1 inline-flex items-center gap-0.5 truncate">
                        <span>Daftar pantau</span>
                        <x-icon name="caret-right" weight="bold" class="text-[10px] text-rose-700 shrink-0" />
                    </a>
                </div>
            </div>
        ...
        {{-- ── 4. TWO-COLUMN OPERATIONAL WORKSPACE (Elevated & Distinct) ── --}}
