...
<div class="mt-auto shrink-0 w-full lg:w-3/4 mx-auto pt-6 flex flex-col sm:flex-row items-center gap-4 pb-6">
    <!-- Action Buttons -->
    <button type="button" class="btn-reject h-[60px] lg:h-[70px] rounded-xl text-rose-500 bg-white border-2 border-rose-100 hover:bg-rose-50 hover:border-rose-300 transition-colors focus:ring-4 focus:ring-rose-50 flex flex-col items-center justify-center gap-1 flex-1 w-full outline-none" data-id="{{ $childId }}">
    ...
    <button type="button" class="btn-approve h-[60px] lg:h-[70px] rounded-xl bg-[#00A9C0] text-white hover:bg-cyan-600 transition-colors focus:ring-4 focus:ring-cyan-100 flex flex-col items-center justify-center gap-1 group flex-1 w-full outline-none shadow-sm" data-id="{{ $childId }}">
        <div class="flex items-center gap-2 font-black text-sm lg:text-base">
