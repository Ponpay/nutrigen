        ...
        <a href="{{ route('kader.dashboard') }}" 
           class="flex flex-col items-center justify-center gap-1 py-1 transition-all duration-200 active:scale-95 {{ request()->routeIs('kader.dashboard') ? 'text-teal-600' : 'text-slate-400 hover:text-slate-600' }}">
            @if(request()->routeIs('kader.dashboard'))
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-[22px] h-[22px] max-w-[22px] max-h-[22px]" style="width: 22px; height: 22px;">
            ...
            @else
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" class="w-[22px] h-[22px] max-w-[22px] max-h-[22px]" style="width: 22px; height: 22px;">
