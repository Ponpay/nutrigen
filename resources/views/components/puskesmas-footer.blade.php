               ...
               class="group relative flex flex-col items-center justify-between h-full pt-2 pb-1 transition-all duration-200 active:scale-95">
                <div class="flex flex-col items-center gap-1">
                    ...
                    @else
                        ...
                        <span class="text-[11px] font-medium text-slate-400 group-hover:text-slate-600 leading-none">Dashboard</span>
                    @endif
                </div>
               ...
               class="group relative flex flex-col items-center justify-between h-full pt-2 pb-1 transition-all duration-200 active:scale-95">
                <div class="flex flex-col items-center gap-1 relative">
                    ...
                    @else
                        ...
                        <span class="text-[11px] font-medium text-slate-400 group-hover:text-slate-600 leading-none">Validasi</span>
                    @endif
                    <!-- Notification badge indicator -->
                    <span class="absolute -top-0.5 right-0 w-2 h-2 rounded-full bg-rose-500 ring-2 ring-white"></span>
                </div>
               ...
               class="group relative flex flex-col items-center justify-between h-full pt-2 pb-1 transition-all duration-200 active:scale-95">
                <div class="flex flex-col items-center gap-1">
                    ...
                    @else
                        ...
                        <span class="text-[11px] font-medium text-slate-400 group-hover:text-slate-600 leading-none">Posyandu</span>
                    @endif
                </div>
